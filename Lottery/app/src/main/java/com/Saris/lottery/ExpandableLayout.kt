...
class ExpandableLayout : LinearLayout {
    ...
    private fun verticalAnimate(startHeight: Int, endHeight: Int) {
        ...
        mExpandAnimator?.addUpdateListener(ValueAnimator.AnimatorUpdateListener { animation ->
    ...
    private fun parentScroll(distance: Int): ValueAnimator? {
        ...
        mParentAnimator?.addUpdateListener(object : ValueAnimator.AnimatorUpdateListener {
            var lastDy = 0
            var dy = 0
